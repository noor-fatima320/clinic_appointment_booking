...
import 'doctor1_appointment_confirmation.dart';

class Doctor1AppointmentScreen extends StatefulWidget {
  const Doctor1AppointmentScreen({super.key});

  @override
  State<Doctor1AppointmentScreen> createState() =>
      _Doctor1AppointmentScreenState();
}

class _Doctor1AppointmentScreenState extends State<Doctor1AppointmentScreen> {
  int selectedDate = 2;
  int selectedTime = 3;
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        Doctor1AppointmentConfirmationScreen(
                                          selectedDay:
