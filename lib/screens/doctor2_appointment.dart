...
import 'doctor2_appointment_confirmation.dart';

class Doctor2AppointmentScreen extends StatefulWidget {
  const Doctor2AppointmentScreen({super.key});

  @override
  State<Doctor2AppointmentScreen> createState() =>
      _Doctor2AppointmentScreenState();
}

class _Doctor2AppointmentScreenState extends State<Doctor2AppointmentScreen> {
  int selectedDate = 2;
  int selectedTime = 3;
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        Doctor2AppointmentConfirmationScreen(
                                          selectedDay:
